...
<div class="row">
    <!-- Only show the chart for the admin role -->
    ...
    <!-- Admin Dashboard Cards (Below the Chart) -->
    <?php foreach ($admin_dashboard_cards as $row): ?>
    <div class="col-md-4">
        <div class="card card-stats card-round" style="background-color: <?= getRandomColor() ?>; color: #fff">
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
...
<?php endif; ?>
  ...
  <script>
    // Data from PHP array
    const data = {
        labels: ['Male', 'Female', 'Voters', 'Non Voters', '4Ps Members', 'PWD Members', 'Senior Members', 'Under Age', 'Adult', 'Requested Certificate', 'Blotter', 'Revenue', 'Hotline'],
        datasets: [{
            label: 'Poblacion Statistics',
            data: [
                <?= $residents_summary['male'] ?>,
                <?= $residents_summary['female'] ?>,
                <?= $residents_summary['voters'] ?>,
                <?= $residents_summary['non_voters'] ?>,
                <?= $residents_summary['total_4ps'] ?>,
                <?= $residents_summary['total_pwds'] ?>,
                <?= $residents_summary['total_seniors'] ?>,
                <?= $residents_summary['under_age'] ?>,
                <?= $residents_summary['adult'] ?>,
                <?= $residents_summary['total'] ?>, 
				<?= $blotter ?>,
				<?= $revenue['am'] ?>,
				<?= $precinct ?>
            ...
            backgroundColor: [
                '#f97316', '#ef4444', '#f59e0b', '#eab308', '#84cc16', '#22c55e', '#10b981', '#8b5cf6', '#6366f1', '#4caf50', '#DE8F5F', '#C6E7FF', '#608BC1'
            ],
            borderColor: [
                '#f97316', '#ef4444', '#f59e0b', '#eab308', '#84cc16', '#22c55e', '#10b981', '#8b5cf6', '#6366f1', '#4caf50', '#DE8F5F', '#C6E7FF', '#608BC1'
            ],
