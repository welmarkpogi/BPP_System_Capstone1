<footer class="footer">
  <div class="container-fluid">
    <div class="copyright ml-auto">
      2024 &copy Barangay Poblacion Profiling  System "Cordova Public College" BSIT-4A 2023-2024
    </div>
  </div>
</footer>
<!-- Modal -->
...
<div class="modal fade" id="support" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-image:url('assets/img/img-shadow.png'); background-size:cover;">
...
<div class="modal fade" id="requestdoc" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-image:url('assets/img/Logo.png'); background-size:cover;">
