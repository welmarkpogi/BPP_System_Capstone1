        ...
        <div class="modal-body">
          ...
          <div class="text-center">
            ...
            <div class="form-group d-flex justify-content-center">
              <button type="button" class="btn btn-secondary btn-sm mr-2" id="open_cam">Open Camera</button>
              <button type="button" class="btn btn-success btn-sm ml-2" onclick="save_photo()">Capture</button>
            </div>
            <div id="profileImage">
