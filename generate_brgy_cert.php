                    ...
                    <div class="row mt-2">
                      <div class="col-md-3">
                        <div class="text-center p-3">
                          <img src="assets/img/Logo.png" class="img-fluid" width="200" />
                          ...
                          <h5 class="mb-2 ">
                            <b>MISSION:</b>
                            <i>
                            To foster a safe, inclusive, and progressive community through sustainable economic development, 
                            improved public services, and the preservation of cultural heritage and natural resources, ensuring a 
                            high quality of life for all residents. We are committed to transparent
                            governance, active community involvement, and innovative solutions for the welfare and resilience of our municipality.
                            </i>
                          </h5>
                        </div>
                      </div>
